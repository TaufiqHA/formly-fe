...
export default function SubmissionDetails({ onBack }: { onBack: () => void }) {
  return (
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-3">
              <h1 className="text-3xl font-bold text-on-surface">Respon #SUB-2023-0891</h1>
          ...
          <div className="bg-surface-container-lowest rounded-2xl border border-outline-variant p-6 shadow-sm">
            ...
            <div className="space-y-6">
              <div className="bg-surface p-4 rounded-xl border border-outline-variant">
                <label className="text-xs font-bold text-on-surface-variant uppercase tracking-widest block mb-1">Layanan Utama</label>
                <p className="text-lg font-bold text-primary">Paket Enterprise Logistik Terpadu</p>
              </div>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-surface p-4 rounded-xl border border-outline-variant">
                  <label className="text-xs font-bold text-on-surface-variant uppercase tracking-widest block mb-1">Pilihan Paket</label>
                  <p className="font-semibold text-on-surface">Premium (50 - 100 Ton)</p>
                </div>
                <div className="bg-surface p-4 rounded-xl border border-outline-variant">
                  <label className="text-xs font-bold text-on-surface-variant uppercase tracking-widest block mb-1">Wilayah Operasional</label>
                  <p className="font-semibold text-on-surface">Jawa - Bali</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <select className="w-full appearance-none bg-surface border border-outline-variant rounded-lg px-4 py-2 text-sm font-bold text-on-surface focus:outline-none focus:ring-1 focus:ring-primary">
                    ...
                    <option value="spam">Tandai Spam</option>
                  </select>
                </div>
              </div>
